...
import SceneMap from './Shared/SceneMap';
...
export default class CustomIndicatorExample extends React.Component<{}, State> {
  static title = 'BeatHarmony';
  static finesseTitle = 'Sign In'
  static backgroundColor = '#3ACCC6';
